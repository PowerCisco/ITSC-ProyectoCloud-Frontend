...
export const BodyAtention = (Paciente, handleChange, openCloseCreateModal, postAtention, DateTime, getAtention, putAtention, openCloseEditModal) => {
  ...
  const bodyEdit = (
    <div className={styles.modal}>
      <center> <h3 className={styles.titles}>Editar Atenciones</h3> </center>
      <div className={styles.cajaPaciente}>
        <TextField name="nombre" className={styles.inputMaterial} disabled label="Nombre" defaultValue={Paciente ? Paciente.nombre : "No tiene"} />
        <br />
        <TextField name="apellido" className={styles.inputMaterial} disabled label="Apellido" value={Paciente ? Paciente.apellido : "No tiene"} />
      ...
      <div className={styles.cajaDiagnostico}>
        <TextField name="diagnostico"
          ...
          label="Diagnostico"
          onChange={handleChange}
          value={getAtention ? getAtention.diagnostico : "No existe"}
        ...
        <TextareaAutosize
          ...
          maxRows={4}
          onChange={handleChange}
          value={getAtention ? getAtention.tratamiento : "No existe"}
        ...
        <TextareaAutosize
          ...
          onChange={handleChange}
          className={styles.modal__textarea_medicamentos}
          value={getAtention ? getAtention.medicamentosIndicados : "No existe"}
